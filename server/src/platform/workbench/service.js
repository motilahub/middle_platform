export function createWorkbenchService(repository, mapApp, imageStore, ssoService) {
  ...
  return {
    ...
    async create(body) {
      ...
      return repository.create([body.code, body.name, body.priority, categoryId(body.categoryId), body.url, body.enabled, image.original, image.thumbnail, image.filename, ssoConfigId, visibility(body.visibility)], body.userIds)
    },
    async update(id, body) {
      ...
      return repository.update(id, [body.name, body.priority, selectedCategoryId, body.url, body.enabled, image.original, image.thumbnail, image.filename, ssoConfigId, visibility(body.visibility)], body.userIds)
    },

export function createWorkbenchService(repository, mapApp, imageStore, ssoService) {
  return {
    ...
    async create(body) {
      ...
      return repository.create([body.code, body.name, body.priority, body.url, body.enabled, image.original, image.thumbnail, image.filename, ssoConfigId], body.userIds)
    },
    async update(id, body) {
      ...
      return repository.update(id, [body.name, body.priority, body.url, body.enabled, image.original, image.thumbnail, image.filename, ssoConfigId], body.userIds)
    },

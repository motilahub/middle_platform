...
export default function Workbench() {
  ...
  </section>{settings.footerRecord && <footer className="system-footer">{settings.footerRecord}</footer>}{user && <button type="button" className="ai-chat-fab" onClick={() => navigate('/ai-chat')} aria-label="打开 AI 对话" title="打开 AI 对话"><img src={settings.aiChatRobotIcon || defaultLogo} alt="" /><span>AI 对话</span></button>}</div>
}

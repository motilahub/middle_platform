...
export default function ModelProviderConfig() {
  ...
  return <div>
    ...
    <Form.Item name="baseUrl" label="服务地址" rules={[{ required: true, message: '请输入服务地址' }, { type: 'url', message: '请输入有效 URL' }]} extra={vendor === 'custom' ? '支持 HTTP/HTTPS，需兼容 OpenAI /models 接口' : undefined}><Input disabled={vendor !== 'custom'} placeholder="http(s)://api.example.com/v1" /></Form.Item>
